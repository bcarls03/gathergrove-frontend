        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: "13px", fontWeight: 600, color: "#334155", marginBottom: "10px", textAlign: "left" }}>
              Invite friends and family not yet on GatherGrove
            </div>
            ...
            <div style={{
              ...
              >
                <span style={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.09 4.18 2 2 0 0 1 4.06 2h3a2 2 0 0 1 2 1.72c.12.86.37 1.7.73 2.5a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.58-1.25a2 2 0 0 1 2.11-.45c.8.36 1.64.61 2.5.73A2 2 0 0 1 22 16.92z" />
                  </svg>
                </span>
                Text Invite
              </button>
